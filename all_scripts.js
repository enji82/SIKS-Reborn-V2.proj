...
function sultan_tampilkanProfilUser() {
    ...
    const boxColor = isDark ? '#252525' : '#f8f9fa';
    const primaryColor = isDark ? '#ff6666' : '#800000';
    ...
    Swal.fire({
        title: `<h5 class="font-weight-bold mb-0" style="color: ${primaryColor}; letter-spacing: 1px; font-size: 1.1rem;">PROFIL PENGGUNA</h5>`,
        html: `
            <div class="text-center mb-4">
                <div class="position-relative d-inline-block mb-3">
                    <img src="${photoUrl}" class="img-circle elevation-2 shadow-sm" style="width: 120px; height: 120px; object-fit: cover; border: 4px solid ${isDark ? '#333' : '#fff'};">
                </div>
                <div class="d-block mb-1">
                    <span class="badge badge-success px-3 py-2 rounded-pill shadow-sm" style="font-size: 0.85rem; font-weight: 600;">
                        <i class="fas fa-check-circle mr-1"></i> TERVERIFIKASI
                    </span>
                </div>
            </div>
            
            <div class="text-left p-3 rounded-lg" style="background: ${boxColor}; border: 1px solid ${borderColor};">
                <div class="row mb-3 align-items-center">
                    <div class="col-4 text-muted">
                        <small style="font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Username</small>
                    </div>
                    <div class="col-8 font-weight-bold" style="color: ${primaryColor}; font-size: 1rem;">
                        ${user.username || '-'}
                    </div>
                </div>
                ...
                <div class="row mb-3 align-items-center">
                    <div class="col-4 text-muted">
                        <small style="font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Unit Kerja</small>
                    </div>
                    <div class="col-8 font-weight-bold" style="color: ${textColor}; font-size: 0.95rem;">
                        ${user.nama_lengkap || '-'}
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-4 text-muted">
                        <small style="font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Hak Akses</small>
                    </div>
                    <div class="col-8">
                        <span class="badge px-3 py-1 shadow-sm" style="background: ${primaryColor}; color: #fff; font-size: 0.8rem; border-radius: 4px;">
        ...
        didOpen: () => {
            $('.swal2-close').css('color', isDark ? '#888' : '#ccc');
        }
    });
}
